...
void setup() {
  ...
  EEPROM.get(0, max_weight);
  text_weight = max_weight;
      ...
      if (key){
        if (key != 'C'){
          ...
          if (text_weight == "0"){
            ...
            text_weight = text_weight + key_str;
          }
          max_weight = text_weight.toFloat();
          EEPROM.put(0, max_weight);
          Serial.println(max_weight);
        }
        else if (key == 'C'){
          text_weight = "0";
          Serial.println(text_weight);
        }
      }
      lcd.setCursor(0, 1);
