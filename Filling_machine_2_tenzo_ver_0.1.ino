...
void setup() {
  ...
  max_weight = (float)((analogRead(potenc_weight) / 150.0) + 4.0);
  ...
  TenzoLeft.setCalFactor(104977.61);        // calibration factor for load cell => strongly dependent on your individual setup
  TenzoRight.begin();
  TenzoRight.start(2000);                 // load cells gets 2000ms of time to stabilize
  TenzoRight.setCalFactor(102538.63);
